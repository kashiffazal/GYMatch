  ...
  return (
    <section className="py-20 sm:py-28 relative overflow-hidden bg-[var(--color-bg-primary)]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div
          className={`p-8 sm:p-14 lg:p-16 relative overflow-hidden ${styles.revolutionCard}`}
        >
          {/* Background Fitness Photo Overlay */}
          <div className="absolute inset-0 z-0 opacity-15 pointer-events-none">
            <Image
              src="/assets/img/sportsman-on-training-endurance-workout-with-ropes-e1601866835973.webp"
          ...
          <div className="relative z-10 space-y-12">
            ...
            <div className="text-center max-w-3xl mx-auto space-y-4">
              ...
              <h2 className="font-bebas text-4xl sm:text-6xl text-[var(--color-foreground)] tracking-wide">
                THE GYMATCH{" "}
                <span className="text-[var(--color-accent)]">REVOLUTION</span>
              </h2>

              <p className="text-base sm:text-lg text-[var(--color-text-muted)] leading-relaxed">
                Compare traditional gym searching friction with GYMatch&apos;s
              ...
              >
                ...
                <ul className="space-y-4 text-sm text-[var(--color-text-muted)]">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      Searching Google Maps manually & calling gyms for
                      equipment details
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-red-400 font-bold text-lg">•</span>
                    <span>
                      Awkwardly asking random gym members for a workout
                      partnership
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-red-400 font-bold text-lg">•</span>
                    <span>
                      Privacy concerns sharing personal social media or cell
                      phone numbers
                    </span>
                  </li>
                </ul>
              ...
              >
                ...
                <ul className="space-y-4 text-sm text-[var(--color-foreground)] font-medium">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      Real-time feed showing active spotters currently at your
                      gym
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      Filter training partners by exact discipline, weight
                      class, or goal
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
