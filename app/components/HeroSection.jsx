    ...
    <section id="hero" className="relative pt-12 pb-24 sm:pt-16 sm:pb-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            {/* Pill Tag */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--color-surface)]/80 backdrop-blur-md border border-[var(--color-border)] shadow-md">
              <Zap className="w-4 h-4 text-[var(--color-accent)] animate-bounce" />
              <span className="text-xs font-bold uppercase tracking-widest text-[var(--color-foreground)]">
                Next-Gen Fitness SaaS Mobile App
              </span>
            </div>

            {/* H1 Main Headline */}
            <h1 className="font-bebas text-5xl sm:text-7xl lg:text-8xl tracking-tight leading-[0.95] text-[var(--color-foreground)]">
              FIND YOUR GYM. <br />
            ...
            <p className="text-base sm:text-lg text-[var(--color-text-muted)] max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              GYMatch is a real-time location-based gym discovery engine and social partner app. Automatically detect nearby gyms, view active spotter feeds, and connect with training partners in seconds.
            </p>
            ...
            <div className="pt-8 border-t border-[var(--color-border)] grid grid-cols-3 gap-4 max-w-lg mx-auto lg:mx-0">
              <div className="text-center lg:text-left">
                ...
                <div className="text-xs text-[var(--color-text-muted)] font-medium uppercase tracking-wider">Matches Made</div>
              </div>
              <div className="text-center lg:text-left">
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="text-xs text-[var(--color-text-muted)] font-medium uppercase tracking-wider">App Rating</div>
              </div>
            </div>
          </motion.div>
            ...
            <div className="relative w-full max-w-[340px]">
              ...
              <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 z-30 w-[90%] max-w-[300px] animate-float-up">
                <div className="flex items-center gap-3 px-4 py-3 rounded-2xl bg-[var(--color-surface)]/95 backdrop-blur-xl border border-[var(--color-border)] shadow-2xl">
                  ...
                  <div>
                    <div className="text-xs font-bold text-[var(--color-foreground)]">32 Spotters Active Now</div>
                    <div className="text-[10px] text-[var(--color-text-muted)]">Within 2.5 miles of your location</div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute top-10 -left-8 sm:-left-14 z-30 hidden sm:flex items-center gap-3 px-4 py-3 rounded-2xl bg-[var(--color-surface)]/95 backdrop-blur-xl border border-[var(--color-border)] shadow-2xl animate-float-down">
                ...
                <div>
                  <div className="text-xs font-bold text-[var(--color-foreground)]">Auto-GPS Detection</div>
                  <div className="text-[10px] text-[var(--color-text-muted)]">Real-time local gyms</div>
                </div>
              </div>
              ...
              <div className="absolute bottom-28 -right-6 sm:-right-12 z-30 hidden sm:flex items-center gap-3 px-4 py-3 rounded-2xl bg-[var(--color-surface)]/95 backdrop-blur-xl border border-[var(--color-border)] shadow-2xl animate-float-up">
                ...
                <div>
                  <div className="text-xs font-bold text-[var(--color-foreground)]">Instant Matching</div>
                  <div className="text-[10px] text-[var(--color-text-muted)]">Temporary safety chat</div>
                </div>
              </div>
            </div>
          </motion.div>
