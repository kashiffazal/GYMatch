    ...
    <section className={styles.ctaSection}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-5 text-center lg:text-left py-10 lg:py-16">
            ...
            <h2 className="font-bebas text-5xl sm:text-6xl lg:text-7xl tracking-tight leading-[0.92] text-[var(--color-foreground)]">
              YOUR FITNESS PARTNER IN <span className="text-[var(--color-accent)]">YOUR CITY</span>
            </h2>

            <p className="text-sm text-[var(--color-text-muted)] font-medium leading-relaxed max-w-md mx-auto lg:mx-0">
              Download GYMatch today and discover nearby gym hubs, find active workout partners, and train with dedicated spotters 24/7.
            </p>
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 pt-1">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-5 py-3.5 rounded-full text-xs font-extrabold uppercase tracking-wider bg-[var(--color-surface)] border border-[var(--color-border)] text-[var(--color-foreground)] hover:border-[var(--color-accent)] hover:text-[var(--color-accent)] transition-all flex items-center gap-2 shadow-lg cursor-pointer"
              >
            ...
            <div className="flex items-center justify-center lg:justify-start gap-6 pt-2 text-xs text-[var(--color-text-muted)] font-semibold">
              <span className="flex items-center gap-1.5">
                <ShieldCheck className="w-4 h-4 text-[var(--color-accent)]" /> 100% Free
              </span>
              <span className="flex items-center gap-1.5">
                <Star className="w-4 h-4 text-[var(--color-accent)] fill-current" /> 4.9 Rating
              </span>
            </div>
          </div>

          {/* Right Column: 2 Phones Only (Compact, Zero Crop) */}
          <div className="relative flex justify-center items-end pb-0 pt-4">
