...
export const TERMS_SECTIONS = [
  {
    id: "legal-agreement",
    title: "1. Legal Agreement & Amendments",
    icon: FileText,
  },
  { id: "definitions", title: "2. Definitions", icon: Scale },
  {
    id: "registration",
    title: "3. Account Integrity & Registration",
    icon: RefreshCw,
  },
  {
  ...
  },
  {
    ...
    title: "5. Spotlight Purchase Policy",
    icon: CreditCard,
  },
  { id: "payments-invoices", title: "6. Payments & Billing", icon: CreditCard },
  {
    id: "fraud-monitoring",
    title: "7. Fraud Monitoring & Safety",
    icon: AlertTriangle,
  },
          ...
          <aside className="lg:col-span-4 lg:sticky lg:top-28 space-y-6">
            ...
            >
              ...
              <p className="text-xs text-[var(--color-text-muted)] leading-relaxed">
                Questions regarding invoice processing, spotlight purchases, or
          ...
          <main className="lg:col-span-8 space-y-8 text-xs sm:text-sm text-[var(--color-text-muted)] leading-relaxed">
            ...
            >
              <div className="flex items-center gap-3 border-b border-[var(--color-border)] pb-4">
                ...
                <h2 className="font-bebas text-3xl text-[var(--color-foreground)] tracking-wide">
                  1. LEGAL AGREEMENT & AMENDMENTS
                </h2>
              </div>
              <p>
                These Terms of Service, in conjunction with our Privacy Policy
                and posted operational guidelines (&ldquo;Legal Terms&rdquo;),
                constitute the entire agreement between you and GYMatch. By
                accessing or utilizing our platform, you agree to comply with
                and be bound by these Legal Terms. If you do not accept these
                terms, you must immediately discontinue use of the GYMatch
                ecosystem. We reserve the right to update these terms to reflect
            ...
            >
              ...
              <ul className="space-y-2.5 pl-2">
                ...
                <li>
                  ...
                  Any individual browsing our platform without registration.
                </li>
                <li>
                  <strong className="text-[var(--color-foreground)]">
                    &ldquo;Member&rdquo;:
                  </strong>{" "}
                  Any individual who has successfully completed registration to
                  access our synchronization and discovery tools.
                </li>
                <li>
                  <strong className="text-[var(--color-foreground)]">
                    &ldquo;Service&rdquo;:
                  </strong>{" "}
                  The collective functionality, partner discovery, and facility
                  mapping tools provided via our mobile applications and web
                  interfaces.
                </li>
                <li>
                  <strong className="text-[var(--color-foreground)]">
                  ...
                  All data, text, graphics, audio, and visual assets provided
            ...
            >
              <div className="flex items-center gap-3 border-b border-[var(--color-border)] pb-4">
                ...
                <h2 className="font-bebas text-3xl text-[var(--color-foreground)] tracking-wide">
                  3. ACCOUNT INTEGRITY & REGISTRATION
                </h2>
              </div>
              <p>
                To access the GYMatch ecosystem, you must provide accurate
                registration data, including your legal name, a verified email
                address, and confirmation that you are 18 years of age or older.
                ...
                The transmission of malicious code, viruses, or any disruptive
                software is strictly prohibited and will result in immediate
                account termination.
              </p>
            </motion.section>
            ...
            >
              ...
              <p>
                The GYMatch platform is provided on an &ldquo;as is&rdquo; and
                &ldquo;as available&rdquo; basis. We do not provide express or
                implied warranties regarding uninterrupted operation,
                merchantability, or fitness for a specific purpose. GYMatch
                shall not be liable for any indirect, incidental, or
                consequential damages, including loss of revenue, data, or
                profits, arising from your use of the platform.
              </p>
            </motion.section>
            ...
            >
              <div className="flex items-center gap-3 border-b border-[var(--color-border)] pb-4">
                ...
                <h2 className="font-bebas text-3xl text-[var(--color-foreground)] tracking-wide">
                  5. SPOTLIGHT PURCHASE POLICY (NO REFUNDS)
                </h2>
              </div>
              <div className="p-4 rounded-2xl bg-[var(--color-accent)]/10 border border-[var(--color-accent)]/30 text-[var(--color-foreground)] font-semibold text-xs">
                By purchasing or utilizing the GYMatch &ldquo;Spotlight&rdquo;
                performance feature, you acknowledge and agree that all
                transactions are final. We maintain a no-refund policy for
                Spotlight placements under any circumstances.
              </div>
            </motion.section>
            ...
            >
              ...
              <p>
                GYMatch reserves the right to specify payment terms for premium
                features. For business-to-business transactions or specific
                Spotlight service agreements, payments must be settled via
                authorized methods (Credit Card, PayPal, or Wire Transfer).
                Overdue balances on invoiced services are subject to a
                late-charge penalty of 1% per month.
              </p>
            </motion.section>
            ...
            >
              <div className="flex items-center gap-3 border-b border-[var(--color-border)] pb-4">
                ...
                <h2 className="font-bebas text-3xl text-[var(--color-foreground)] tracking-wide">
                  7. FRAUD MONITORING & SAFETY
                </h2>
              </div>
              <p>
                GYMatch actively monitors for fraudulent activity, including the
                creation of fake profiles or impersonation. Any breach of these
                protocols will result in the immediate removal of the offending
                account. We reserve the right to pursue all available legal
                remedies against parties engaging in fraudulent behavior, and
                offending users shall be responsible for all costs and legal
                fees incurred by GYMatch.
              </p>
            </motion.section>
            ...
            >
              ...
              <p>
                These Legal Terms shall be performed in and governed by the laws
                of the State of California, United States, without regard to
                conflict of law principles. Any legal action initiated by a user
                must be filed within one (1) year of the date the cause of
                action arose; failure to do so will result in the claim being
                permanently barred.
              </p>
            </motion.section>
          </main>
